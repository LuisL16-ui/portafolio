        ...
        <Box sx={{ textAlign: 'center' }}>
          ...
          >
            <Stack direction="row" spacing={2} justifyContent="center">
              {[
                { icon: GitHub, href: "https://github.com/LuisL16-ui", label: "GitHub", color: "#333" },
                { icon: LinkedIn, href: "https://www.linkedin.com/in/luis-lopez-7a33a9281/", label: "LinkedIn", color: "#0077b5" },
                { 
                  icon: Email, 
                  href: "#contact", 
                  label: "Email", 
